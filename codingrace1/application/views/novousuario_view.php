        ...
        <div class="w3-container w3-center">
            ...
            <form class="w3-container w3-card-4 w3-light-grey w3-text-black w3-margin" method="post" enctype="multipart/form-data">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border" name="nome" id="nome" type="text" placeholder="Nome" value="<?=set_value('nome')?>">
                    </div>
                </div>
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border" name="ra" id="ra" type="text" placeholder="RA" value="<?=set_value('ra')?>">
                    </div>
                </div>
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border" name="email" id="email" type="text" placeholder="Email" value="<?=set_value('email')?>">
                    </div>
                </div>
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border" name="senha" id="senha" type="password" placeholder="Senha" <?=set_value('senha')?>>
                    </div>
                </div>

                <p class="w3-center">
                    <button class="w3-btn w3-section w3-black w3-ripple" type="submit" value="salvar"> Salvar </button>
                    <button onclick="location.href='<?php echo base_url('usuarios');?>'" type="button" class="w3-btn w3-section w3-black w3-ripple">Cancel</button>
                </p>
            </form>
